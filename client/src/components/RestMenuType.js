...
class RestMenuType extends Component{
    constructor(props){
        super(props);
        this.state = {
            rest_type:'',
    ...
    onFormSubmit(e){
        ...
        if(this.state.file == null){
            alert(APP_CONSTANT.APP_CONSTANTS.CuisineCreate.ImageNotAdded);
            return false;
          }
        ...
        API.post("/menutype/create",formData,config)
            .then((response) => {
              if(response.data === "A Cuisine already Exists with the name"){
                alert(APP_CONSTANT.APP_CONSTANTS.CuisineCreate.AlreadyExist)
                this.setState({success : false})
              }else{
                alert(APP_CONSTANT.APP_CONSTANTS.CuisineCreate.Success);
    ...
    render() {
        ...
        return (
            ...
            <div className={classes.root}>
                <CssBaseline />
                <AppBarApp name={APP_CONSTANT.APP_CONSTANTS.CuisineCreate.Cuisine}/>
                <main className={classes.content}>
                 ...
                 <Typography component="h1" variant="h5">
                    {APP_CONSTANT.APP_CONSTANTS.CuisineCreate.CreateCuisine}
                </Typography>
                <form className={classes.form1} onSubmit={this.onFormSubmit}>
                    <TextField
                        ...
                        fullWidth
                        id="rest_type"
                        label={APP_CONSTANT.APP_CONSTANTS.CuisineCreate.CuisineName}
                        name="rest_type"
                    ...
                    />
                     <TextField
                        ...
                        required
                        fullWidth
                        label ={APP_CONSTANT.APP_CONSTANTS.CuisineCreate.CuisineDesc}
                       name ='hubdesc'
                  ...
                  />
                    ...
                    <label htmlFor="icon-button-photo" className={classes.label}>
                        {APP_CONSTANT.APP_CONSTANTS.CuisineCreate.CuisineImage} <IconButton color="primary" component="span">
                            <PhotoCamera />
                        </IconButton>
                    </label>
                    {this.state.hasFile ? 
                    ...
                    >
                    {APP_CONSTANT.APP_CONSTANTS.CuisineCreate.Create}
                    </Button>
                    </form>
                 </div>
...
export default (withStyles(styles)(RestMenuType))