...
class BrandEdit extends Component{
    ...
    async componentDidMount(){
        var brandId = this.props.match.params.id;
        var brand_name;
        var imageURL;
        var filename;
        await API.get('/branddetails', {
            params: {
                id: brandId,
              }
            })
    ...
    onFormSubmit(e){
        ...
        formData.append('brand_id',this.props.match.params.id);
        ...
        API.post("/brand/edit",formData,config)
            .then((response) => {
                alert(APP_CONSTANT.APP_CONSTANTS.BrandEdit.EditSuccess);
            }).catch((error) => {
                console.log(error)
        });
    }
    ...
    render() {
        ...
        return (
            ...
            <div className={classes.root}>
                <CssBaseline />
                <AppBarApp name={APP_CONSTANT.APP_CONSTANTS.BrandEdit.Brand}/>
                {this.state.loading ? 
                <main className={classes.content}>
                 ...
                 {APP_CONSTANT.APP_CONSTANTS.BrandEdit.EditBrand} : {this.state.brand_name}
                </Typography>
                <form className={classes.form1} onSubmit={this.onFormSubmit}>
                    <TextField
                        ...
                        fullWidth
                        id="brand_name"
                        label={APP_CONSTANT.APP_CONSTANTS.BrandEdit.BrandName}
                        name="brand_name"
                    ...
                    />
                     <TextField
                        ...
                        required
                        fullWidth
                        label ={APP_CONSTANT.APP_CONSTANTS.BrandEdit.BrandDesc}
                       name ='desc'
                  ...
                  />
                    ...
                    {APP_CONSTANT.APP_CONSTANTS.BrandEdit.AddImage} <IconButton color="primary" component="span">
                            <PhotoCamera />
                        </IconButton>
                    </label>
                    {this.state.hasFile ? 
                    ...
                    >
                    {APP_CONSTANT.APP_CONSTANTS.BrandEdit.Edit}
                    </Button>
                    </form>
                 </div>
...
export default (withStyles(styles)(BrandEdit))