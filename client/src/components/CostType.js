...
class CostType extends Component{
    ...
    onFormSubmit(e){
        ...
        if(this.state.file == null){
          alert(APP_CONSTANT.APP_CONSTANTS.PricingCategory.ImageNotAdded);
          return false;
        }
        ...
        API.post("/costtype/create",formData,config)
            .then((response) => {
                alert(APP_CONSTANT.APP_CONSTANTS.PricingCategory.Success);
            }).catch((error) => {
                console.log(error)
        });
    }
            ...
            <div className={classes.root}>
                ...
                <main className={classes.content}>
                 ...
                 <Typography component="h1" variant="h5">
                    {APP_CONSTANT.APP_CONSTANTS.PricingCategory.Create}
                </Typography>
                <form className={classes.form1} onSubmit={this.onFormSubmit}>
                    <TextField
                        ...
                        fullWidth
                        id="cost_type"
                        label={APP_CONSTANT.APP_CONSTANTS.PricingCategory.PricingType}
                        name="cost_type"
                    ...
                    />
                     <TextField
                        ...
                        required
                        fullWidth
                        label ={APP_CONSTANT.APP_CONSTANTS.PricingCategory.PricingDesc}
                       name ='desc'
                  ...
                  />
                    ...
                    <label htmlFor="icon-button-photo" className={classes.label}>
                        {APP_CONSTANT.APP_CONSTANTS.PricingCategory.AddImage} <IconButton color="primary" component="span">
                            <PhotoCamera />
                        </IconButton>
                    </label>
                    {this.state.hasFile ? 
