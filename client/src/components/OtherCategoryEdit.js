...
class OtherCategoryEdit extends Component{
    constructor(props){
        super(props);
        this.state = {
            category_name:'',
    ...
    onFormSubmit(e){
        ...
        API.post("/category/create",formData,config)
            .then((response) => {
                alert(APP_CONSTANT.APP_CONSTANTS.OtherCategoryEdit.Success);
            }).catch((error) => {
                console.log(error)
        });
    }
    ...
    render() {
        ...
        return (
            ...
            <div className={classes.root}>
                <CssBaseline />
                <AppBarApp name={APP_CONSTANT.APP_CONSTANTS.OtherCategoryEdit.OtherCategories}/>
                {this.state.loading ? 
                <main className={classes.content}>
                 ...
                 <Typography component="h1" variant="h5">
                  {APP_CONSTANT.APP_CONSTANTS.OtherCategoryEdit.CreateCategory} : {this.state.category_name}
                </Typography>
                <form className={classes.form1} onSubmit={this.onFormSubmit}>
                    <TextField
                        ...
                        fullWidth
                        id="category_name"
                        label={APP_CONSTANT.APP_CONSTANTS.OtherCategoryEdit.CategoryName}
                        name="category_name"
                    ...
                    />
                     <TextField
                        ...
                        required
                        fullWidth
                        label ={APP_CONSTANT.APP_CONSTANTS.OtherCategoryEdit.CategoryDesc}
                       name ='desc'
                  ...
                  />
                    ...
                    <label htmlFor="icon-button-photo" className={classes.label}>
                        {APP_CONSTANT.APP_CONSTANTS.OtherCategoryEdit.CategoryImage} <IconButton color="primary" component="span">
                            <PhotoCamera />
                        </IconButton>
                    </label>
                    {this.state.hasFile ? 
                    ...
                    >
                    {APP_CONSTANT.APP_CONSTANTS.OtherCategoryEdit.Edit}
                    </Button>
                    </form>
                 </div>
...
export default (withStyles(styles)(OtherCategoryEdit))