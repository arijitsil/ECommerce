...
class RestaurantEdit extends Component{
    ...
    onChangeSelect(event,value){
      ...
      onChangeSubLocationSelect(event,value){
       ...
       if(value !== null){
        ...
        // this.setState({sublocation : value.name});
    ...
    async componentDidMount() {  
        ...
        var pricingLevel;
        var address;
        await API.get('/restaurantdetails', {
            params: {
              id: restId,
            }
          })
        .then(function (response) {
         console.log(response);
          ...
          var basicRestDetails = response.data[0].data;
         
          rest_name = basicRestDetails[0].rest_name;
          address = basicRestDetails[0].rest_address;
          rest_about = basicRestDetails[0].rest_special_about;
          rest_specialConditions = basicRestDetails[0].rest_special_instruction;
          spoken_languages = basicRestDetails[0].rest_spoken_languages;
          lat  = basicRestDetails[0].lat;
          long = basicRestDetails[0].long;
          paymentmode = basicRestDetails[0].rest_payment_mode;
          email_address = basicRestDetails[0].rest_email_address;
          phone = basicRestDetails[0].rest_contact_number;
          imageURLs= response.data[1].data[0];
          restCuisine = response.data[2].data;
          restSegment = response.data[3].data;
          restLocation = response.data[4].data;
          restSubloc = response.data[5].data;
          reshub = response.data[6].data;
          rest_happy = response.data[7].data;
          rest_oper = response.data[8].data;
          rest_menu = response.data[9].data;
          cost_type = response.data[10].data;
          pricingLevel = response.data[11].data;
          if(typeof response.data[12] !== 'undefined'){
              brand_name = response.data[11].data;
          }
        ...
        for(var i=0;i<imageURLs.length;i++){
            ...
            var fileName = imageURL.substr(imageURL.lastIndexOf('/')+1,imageURL.length);
            fileNames.push(fileName);
        }
        
        this.setState({rest_name : rest_name, 
            hubdesc : rest_about, 
            specialConditions :rest_specialConditions,
            lat : lat,
            long : long,
            address : address,
            email_address : email_address,
            phone_number : phone,
            pricingLevelSelectedValue : pricingLevel[0],
            locationSelectedValue : restLocation[0],
            sublocationsSelectedValue : restSubloc[0],
            hubsSelectedValue : reshub[0],
            cuisinesSubmitValue : restCuisine[0],
            segmentSubmitValue : restSegment[0],
            costTypeSubmitValue : cost_type[0],
            brandSubmitValue : brand_name[0],
            discountHours : rest_happy[0],
            recommendedMenus : rest_menu[0],
            operatingHours : rest_oper[0],
        ...
        await axios.all([cuisines,segments,brands,costtype])
        .then(
    ...
    onFormSubmit(e){
        ...
        formData.append('rest_id', this.props.match.params.id);
        ...
        API.post("/restaurant/edit",formData,config)
            .then((response) => {
                alert(APP_CONSTANT.APP_CONSTANTS.RestCreate.RestSuccessEdit);
            }).catch((error) => {
                console.log(error)
        });
    }
    onChange(e) {
        ...
        if(targetName === "rest_name"){
          ...
          this.setState({hubdesc:e.target.value});
            ...
            this.setState({files : [], images : [], hasFile: false})
            var fileNameArray = []
        ...
        switch(steps){
            case 1:
                return (
                    ...
                    <Typography component="h1" variant="h5">
                        {APP_CONSTANT.APP_CONSTANTS.RestCreate.EditRes} : {this.state.rest_name}
                    </Typography>
            ...
            case 2: 
                return(
                    ...
                    <div className={classes.paper1} style={{width : '80%'}}>
                    <Typography component="h1" variant="h5">
                        {APP_CONSTANT.APP_CONSTANTS.RestCreate.EditDisc} : {this.state.rest_name}
                    </Typography>
            ...
            case 3 :
                return (
                    ...
                    <div className={classes.paper1} style={{width : '80%'}}>
                    <Typography component="h1" variant="h5">
                       {APP_CONSTANT.APP_CONSTANTS.RestCreate.EditRecMenu} :  {this.state.rest_name}
                    </Typography>
                    <RecommendedMenu 
                        nextStep = {this.nextStep}
                        values = {values}
            ...
            case 4 :
                return (
                    ...
                    <div className={classes.paper1} style={{width : '80%'}}>
                    <Typography component="h1" variant="h5">
                        {APP_CONSTANT.APP_CONSTANTS.RestCreate.EditOppHours} :  {this.state.rest_name}
                    </Typography>
                    <OperatingHours 
                        nextStep = {this.nextStep}
                        values = {values}
            ...
            case 5 :
                return (
                    ...
                    <Typography component="h1" variant="h4" style={{alignSelf:'center', marginBottom : '30px'}}>
                        {APP_CONSTANT.APP_CONSTANTS.RestCreate.EditRestComfirm} :  {this.state.rest_name}
                    </Typography>
