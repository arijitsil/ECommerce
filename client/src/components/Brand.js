...
class Brand extends Component{
    ...
    onFormSubmit(e){
        ...
        if(this.state.file == null){
            alert(APP_CONSTANT.APP_CONSTANTS.BrandCreate.ImageNotAdded);
            return false;
        }
        ...
        API.post("/brand/create",formData,config)
            .then((response) => {
                alert(APP_CONSTANT.APP_CONSTANTS.BrandCreate.BrandCreate);
            }).catch((error) => {
                console.log(error)
        });
    }
            ...
            <div className={classes.root}>
                ...
                <main className={classes.content}>
                 ...
                 <Typography component="h1" variant="h5">
                  {APP_CONSTANT.APP_CONSTANTS.BrandCreate.AddBrand}
                </Typography>
                <form className={classes.form1} onSubmit={this.onFormSubmit}>
                    <TextField
                        ...
                        fullWidth
                        id="brand_name"
                        label={APP_CONSTANT.APP_CONSTANTS.BrandCreate.BrandName}
                        name="brand_name"
                    ...
                    />
                     <TextField
                        ...
                        required
                        fullWidth
                        label ={APP_CONSTANT.APP_CONSTANTS.BrandCreate.BrandDesc}
                       name ='desc'
                  ...
                  />
                    ...
                    {APP_CONSTANT.APP_CONSTANTS.BrandCreate.AddImage} <IconButton color="primary" component="span">
                            <PhotoCamera />
                        </IconButton>
                    </label>
                    {this.state.hasFile ? 
                    ...
                    >
                    {APP_CONSTANT.APP_CONSTANTS.BrandCreate.Create}
                    </Button>
                    </form>
                 </div>
